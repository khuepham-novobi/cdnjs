...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class t{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((e,t)=>{this.resolve=e,this.reject=t})}wrapCallback(e){return(t,n)=>{t?this.reject(t):this.resolve(n),"function"==typeof e&&(this.promise.catch(()=>{}),1===e.length?e(t):e(t,n))}}}class n extends Error{constructor(e,t){super(t),this.code=e,this.name="FirebaseError",Object.setPrototypeOf(this,n.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,r.prototype.create)}}class r{constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}create(e,...t){const r=t[0]||{},o=`${this.service}/${e}`,s=this.errors[e],a=s?function(e,t){return e.replace(i,(e,n)=>{const r=t[n];return null!=r?String(r):`<${n}?>`})}(s,r):"Error",c=`${this.serviceName}: ${a} (${o}).`,u=new n(o,c);for(const e of Object.keys(r))"_"!==e.slice(-1)&&(e in u&&console.warn(`Overwriting FirebaseError base field "${e}" can cause unexpected behavior.`),u[e]=r[e]);return u}}const i=/\{\$([^}]+)}/g;
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
const E=function(){const e=_(w);e.SDK_VERSION=e.SDK_VERSION+"_LITE";const t=e.INTERNAL.registerComponent;return e.INTERNAL.registerComponent=function(e){if("PUBLIC"===e.type&&"performance"!==e.name&&"installations"!==e.name)throw Error(name+" cannot register with the standalone perf instance");return t(e)},e}();function S(e){return Array.prototype.slice.call(e)}function T(e){return new Promise((function(t,n){e.onsuccess=function(){t(e.result)},e.onerror=function(){n(e.error)}}))}function A(e,t,n){var r,i=new Promise((function(i,o){T(r=e[t].apply(e,n)).then(i,o)}));return i.request=r,i}function N(e,t,n){var r=A(e,t,n);return r.then((function(e){if(e)return new L(e,r.request)}))}function O(e,t,n){n.forEach((function(n){Object.defineProperty(e.prototype,n,{get:function(){return this[t][n]},set:function(e){this[t][n]=e}})}))}function C(e,t,n,r){r.forEach((function(r){r in n.prototype&&(e.prototype[r]=function(){return A(this[t],r,arguments)})}))}function k(e,t,n,r){r.forEach((function(r){r in n.prototype&&(e.prototype[r]=function(){return this[t][r].apply(this[t],arguments)})}))}function D(e,t,n,r){r.forEach((function(r){r in n.prototype&&(e.prototype[r]=function(){return N(this[t],r,arguments)})}))}function R(e){this._index=e}function L(e,t){this._cursor=e,this._request=t}function P(e){this._store=e}function j(e){this._tx=e,this.complete=new Promise((function(t,n){e.oncomplete=function(){t()},e.onerror=function(){n(e.error)},e.onabort=function(){n(e.error)}}))}function M(e,t,n){this._db=e,this.oldVersion=t,this.transaction=new j(n)}function B(e){this._db=e}!function(e,t){e.INTERNAL.registerComponent(new s("platform-logger",e=>new I(e),"PRIVATE")),e.registerVersion("@firebase/app","0.6.10",t),e.registerVersion("fire-js","")}(E,"lite"),O(R,"_index",["name","keyPath","multiEntry","unique"]),C(R,"_index",IDBIndex,["get","getKey","getAll","getAllKeys","count"]),D(R,"_index",IDBIndex,["openCursor","openKeyCursor"]),O(L,"_cursor",["direction","key","primaryKey","value"]),C(L,"_cursor",IDBCursor,["update","delete"]),["advance","continue","continuePrimaryKey"].forEach((function(e){e in IDBCursor.prototype&&(L.prototype[e]=function(){var t=this,n=arguments;return Promise.resolve().then((function(){return t._cursor[e].apply(t._cursor,n),T(t._request).then((function(e){if(e)return new L(e,t._request)}))}))})})),P.prototype.createIndex=function(){return new R(this._store.createIndex.apply(this._store,arguments))},P.prototype.index=function(){return new R(this._store.index.apply(this._store,arguments))},O(P,"_store",["name","keyPath","indexNames","autoIncrement"]),C(P,"_store",IDBObjectStore,["put","add","delete","clear","get","getAll","getKey","getAllKeys","count"]),D(P,"_store",IDBObjectStore,["openCursor","openKeyCursor"]),k(P,"_store",IDBObjectStore,["deleteIndex"]),j.prototype.objectStore=function(){return new P(this._tx.objectStore.apply(this._tx,arguments))},O(j,"_tx",["objectStoreNames","mode"]),k(j,"_tx",IDBTransaction,["abort"]),M.prototype.createObjectStore=function(){return new P(this._db.createObjectStore.apply(this._db,arguments))},O(M,"_db",["name","version","objectStoreNames"]),k(M,"_db",IDBDatabase,["deleteObjectStore","close"]),B.prototype.transaction=function(){return new j(this._db.transaction.apply(this._db,arguments))},O(B,"_db",["name","version","objectStoreNames"]),k(B,"_db",IDBDatabase,["close"]),["openCursor","openKeyCursor"].forEach((function(e){[P,R].forEach((function(t){e in t.prototype&&(t.prototype[e.replace("open","iterate")]=function(){var t=S(arguments),n=t[t.length-1],r=this._store||this._index,i=r[e].apply(r,t.slice(0,-1));i.onsuccess=function(){n(i.result)}})}))})),[R,P].forEach((function(e){e.prototype.getAll||(e.prototype.getAll=function(e,t){var n=this,r=[];return new Promise((function(i){n.iterateCursor(e,(function(e){e?(r.push(e.value),void 0===t||r.length!=t?e.continue():i(r)):i(r)}))}))})}));const F=new r("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function U(e){return e instanceof n&&e.code.includes("request-failed")}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const ne="firebase-installations-store";let re=null;function ie(){return re||(re=function(e,t,n){var r=A(indexedDB,"open",[e,t]),i=r.request;return i&&(i.onupgradeneeded=function(e){n&&n(new M(i.result,e.oldVersion,i.transaction))}),r.then((function(e){return new B(e)}))}("firebase-installations-database",1,e=>{switch(e.oldVersion){case 0:e.createObjectStore(ne)}})),re}async function oe(e,t){const n=J(e),r=(await ie()).transaction(ne,"readwrite"),i=r.objectStore(ne),o=await i.get(n);return await i.put(t,n),await r.complete,o&&o.fid===t.fid||Z(e,t.fid),t}async function se(e){const t=J(e),n=(await ie()).transaction(ne,"readwrite");await n.objectStore(ne).delete(t),await n.complete}async function ae(e,t){const n=J(e),r=(await ie()).transaction(ne,"readwrite"),i=r.objectStore(ne),o=await i.get(n),s=t(o);return void 0===s?await i.delete(n):await i.put(s,n),await r.complete,!s||o&&o.fid===s.fid||Z(e,s.fid),s}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */}async function fe({appConfig:e,platformLoggerProvider:t},n){const r=function(e,{fid:t}){return`${$(e)}/${t}/authTokens:generate`}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e,n),i=H(e,n),o=t.getImmediate({optional:!0});o&&i.append("x-firebase-client",o.getPlatformInfoString());const s={installation:{sdkVersion:"w:0.4.16"}},a={method:"POST",headers:i,body:JSON.stringify(s)},c=await K(()=>fetch(r,a));if(c.ok){return x(await c.json())}throw await q("Generate Auth Token",c)}async function he(e,t=!1){let n;const r=await ae(e.appConfig,r=>{if(!ge(r))throw F.create("not-registered");const i=r.authToken;if(!t&&function(e){return 2===e.requestStatus&&!function(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+36e5}(e)}(i))return r;if(1===i.requestStatus)return n=async function(e,t){let n=await de(e.appConfig);for(;1===n.authToken.requestStatus;)await z(100),n=await de(e.appConfig);const r=n.authToken;return 0===r.requestStatus?he(e,t):r}(e,t),r;{if(!navigator.onLine)throw F.create("app-offline");const t=function(e){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}(r);return n=async function(e,t){try{const n=await fe(e,t),r=Object.assign(Object.assign({},t),{authToken:n});return await oe(e.appConfig,r),n}catch(n){if(!U(n)||401!==n.serverCode&&404!==n.serverCode){const n=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await oe(e.appConfig,n)}else await se(e.appConfig);throw n}}(e,t),t}});return n?await n:r.authToken}function de(e){return ae(e,e=>{if(!ge(e))throw F.create("not-registered");const t=e.authToken;return 1===(n=t).requestStatus&&n.requestTime+1e4<Date.now()?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e;var n;
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e.appConfig);return(await he(e,t)).token}async function be(e,t){const n=function(e,{fid:t}){return`${$(e)}/${t}`}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e,t),r={method:"DELETE",headers:H(e,t)},i=await K(()=>fetch(n,r));if(!i.ok)throw await q("Delete Installation",i)}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function we(e){return F.create("missing-app-config-values",{valueName:e})}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */var ye;(ye=E).INTERNAL.registerComponent(new s("installations",e=>{const t=e.getProvider("app").getImmediate(),n={appConfig:function(e){if(!e||!e.options)throw we("App Configuration");if(!e.name)throw we("App Name");const t=["projectId","apiKey","appId"];for(const n of t)if(!e.options[n])throw we(n);return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}(t),platformLoggerProvider:e.getProvider("platform-logger")};return{app:t,getId:()=>async function(e){const{installationEntry:t,registrationPromise:n}=await ce(e.appConfig);return n?n.catch(console.error):he(e).catch(console.error),t.fid}(n),getToken:e=>me(n,e),delete:()=>async function(e){const{appConfig:t}=e,n=await ae(t,e=>{if(!e||0!==e.registrationStatus)return e});if(n){if(1===n.registrationStatus)throw F.create("delete-pending-registration");if(2===n.registrationStatus){if(!navigator.onLine)throw F.create("app-offline");await be(t,n),await se(t)}}}(n),onIdChange:e=>ve(n,e)}},"PUBLIC")),ye.registerVersion("@firebase/installations","0.4.16");const _e=new r("performance","Performance",{"trace started":"Trace {$traceName} was started before.","trace stopped":"Trace {$traceName} is not running.","no window":"Window is not available.","no app id":"App id is not available.","no project id":"Project id is not available.","no api key":"Api key is not available.","invalid cc log":"Attempted to queue invalid cc event","FB not default":"Performance can only start when Firebase app instance is the default one.","RC response not ok":"RC response is not ok","invalid attribute name":"Attribute name {$attributeName} is invalid.","invalid attribute value":"Attribute value {$attributeValue} is invalid.","invalid custom metric name":"Custom metric name {$customMetricName} is invalid","invalid String merger input":"Input for String merger is invalid, contact support team to resolve."}),Ie=new g("Performance");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
let Ee,Se,Te,Ae;Ie.logLevel=l.INFO;class Ne{constructor(e){if(this.window=e,!e)throw _e.create("no window");this.performance=e.performance,this.PerformanceObserver=e.PerformanceObserver,this.windowLocation=e.location,this.navigator=e.navigator,this.document=e.document,this.navigator&&this.navigator.cookieEnabled&&(this.localStorage=e.localStorage),e.perfMetrics&&e.perfMetrics.onFirstInputDelay&&(this.onFirstInputDelay=e.perfMetrics.onFirstInputDelay)}getUrl(){return this.windowLocation.href.split("?")[0]}mark(e){this.performance&&this.performance.mark&&this.performance.mark(e)}measure(e,t,n){this.performance&&this.performance.measure&&this.performance.measure(e,t,n)}getEntriesByType(e){return this.performance&&this.performance.getEntriesByType?this.performance.getEntriesByType(e):[]}getEntriesByName(e){return this.performance&&this.performance.getEntriesByName?this.performance.getEntriesByName(e):[]}getTimeOrigin(){return this.performance&&(this.performance.timeOrigin||this.performance.timing.navigationStart)}requiredApisAvailable(){return fetch&&Promise&&this.navigator&&this.navigator.cookieEnabled?"indexedDB"in self&&null!==indexedDB||(Ie.info("IndexedDB is not supported by current browswer"),!1):(Ie.info("Firebase Performance cannot start if browser does not support fetch and Promise or cookie is disabled."),!1)}setupObserver(e,t){if(!this.PerformanceObserver)return;new this.PerformanceObserver(e=>{for(const n of e.getEntries())t(n)}).observe({entryTypes:[e]})}static getInstance(){return void 0===Ee&&(Ee=new Ne(Se)),Ee}}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
function Oe(e,t){const n=e.length-t.length;if(n<0||n>1)throw _e.create("invalid String merger input");const r=[];for(let n=0;n<e.length;n++)r.push(e.charAt(n)),t.length>n&&r.push(t.charAt(n));return r.join("")}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Ce{constructor(){this.instrumentationEnabled=!0,this.dataCollectionEnabled=!0,this.loggingEnabled=!1,this.tracesSamplingRate=1,this.networkRequestsSamplingRate=1,this.logEndPointUrl="https://firebaselogging.googleapis.com/v0cc/log?format=json_proto",this.flTransportEndpointUrl=Oe("hts/frbslgigp.ogepscmv/ieo/eaylg","tp:/ieaeogn-agolai.o/1frlglgc/o"),this.transportKey=Oe("AzSC8r6ReiGqFMyfvgow","Iayx0u-XT3vksVM-pIV"),this.logSource=462,this.logTraceAfterSampling=!1,this.logNetworkAfterSampling=!1,this.configTimeToLive=12}getAppId(){const e=this.firebaseAppInstance&&this.firebaseAppInstance.options&&this.firebaseAppInstance.options.appId;if(!e)throw _e.create("no app id");return e}getProjectId(){const e=this.firebaseAppInstance&&this.firebaseAppInstance.options&&this.firebaseAppInstance.options.projectId;if(!e)throw _e.create("no project id");return e}getApiKey(){const e=this.firebaseAppInstance&&this.firebaseAppInstance.options&&this.firebaseAppInstance.options.apiKey;if(!e)throw _e.create("no api key");return e}getFlTransportFullUrl(){return this.flTransportEndpointUrl.concat("?key=",this.transportKey)}static getInstance(){return void 0===Te&&(Te=new Ce),Te}}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var De;!function(e){e[e.UNKNOWN=0]="UNKNOWN",e[e.VISIBLE=1]="VISIBLE",e[e.HIDDEN=2]="HIDDEN"}(De||(De={}));const Re=["firebase_","google_","ga_"],Le=new RegExp("^[a-zA-Z]\\w*$");function Pe(){const e=Ne.getInstance().navigator;return"serviceWorker"in e?e.serviceWorker.controller?2:3:1}function je(){switch(Ne.getInstance().document.visibilityState){case"visible":return De.VISIBLE;case"hidden":return De.HIDDEN;default:return De.UNKNOWN}}function Me(){const e=Ne.getInstance().navigator.connection;switch(e&&e.effectiveType){case"slow-2g":return 1;case"2g":return 2;case"3g":return 3;case"4g":return 4;default:return 0}}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
const Be=!0;function Fe(e){const t=function(){const e=Ne.getInstance().localStorage;if(!e)return;const t=e.getItem("@firebase/performance/configexpire");if(!(t&&(n=t,Number(n)>Date.now())))return;var n;const r=e.getItem("@firebase/performance/config");if(!r)return;try{return JSON.parse(r)}catch(e){return}}();return t?(Ue(t),Promise.resolve()):function(e){return function(){const e=Ce.getInstance().installationsService.getToken();return e.then(e=>{}),e}().then(t=>{const n=`https://firebaseremoteconfig.googleapis.com/v1/projects/${Ce.getInstance().getProjectId()}/namespaces/fireperf:fetch?key=${Ce.getInstance().getApiKey()}`,r=new Request(n,{method:"POST",headers:{Authorization:"FIREBASE_INSTALLATIONS_AUTH "+t},body:JSON.stringify({app_instance_id:e,app_instance_id_token:t,app_id:Ce.getInstance().getAppId(),app_version:"0.4.0-202071902151",sdk_version:"0.0.1"})});return fetch(r).then(e=>{if(e.ok)return e.json();throw _e.create("RC response not ok")})}).catch(()=>{Ie.info("Could not fetch config, will use default configs")})}(e).then(Ue).then(e=>function(e){const t=Ne.getInstance().localStorage;if(!e||!t)return;t.setItem("@firebase/performance/config",JSON.stringify(e)),t.setItem("@firebase/performance/configexpire",String(Date.now()+60*Ce.getInstance().configTimeToLive*60*1e3))}(e),()=>{})}function Ue(e){if(!e)return e;const t=Ce.getInstance(),n=e.entries||{};return void 0!==n.fpr_enabled?t.loggingEnabled="true"===String(n.fpr_enabled):t.loggingEnabled=Be,n.fpr_log_source&&(t.logSource=Number(n.fpr_log_source)),n.fpr_log_endpoint_url&&(t.logEndPointUrl=n.fpr_log_endpoint_url),n.fpr_log_transport_key&&(t.transportKey=n.fpr_log_transport_key),void 0!==n.fpr_vc_network_request_sampling_rate&&(t.networkRequestsSamplingRate=Number(n.fpr_vc_network_request_sampling_rate)),void 0!==n.fpr_vc_trace_sampling_rate&&(t.tracesSamplingRate=Number(n.fpr_vc_trace_sampling_rate)),t.logTraceAfterSampling=$e(t.tracesSamplingRate),t.logNetworkAfterSampling=$e(t.networkRequestsSamplingRate),e}function $e(e){return Math.random()<=e}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let xe,qe=1;function Ve(){return qe=2,xe=xe||function(){const e=Ne.getInstance().document;return new Promise(t=>{if(e&&"complete"!==e.readyState){const n=()=>{"complete"===e.readyState&&(e.removeEventListener("readystatechange",n),t())};e.addEventListener("readystatechange",n)}else t()})}().then(()=>function(){const e=Ce.getInstance().installationsService.getId();return e.then(e=>{Ae=e}),e}()).then(e=>Fe(e)).then(()=>He(),()=>He()),xe}function He(){qe=3}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let Ke,ze=3,We=[],Ge=!1;function Je(e){setTimeout(()=>{if(0!==ze)return We.length?void function(){const e=[...We];We=[];const t=e.map(e=>({source_extension_json_proto3:e.message,event_time_ms:String(e.eventTime)}));(function(e,t){return function(e){const t=Ce.getInstance().getFlTransportFullUrl();return fetch(t,{method:"POST",body:JSON.stringify(e)})}(e).then(e=>(e.ok||Ie.info("Call to Firebase backend failed."),e.json())).then(e=>{const n=Number(e.nextRequestWaitMillis);let r=1e4;isNaN(n)||(r=Math.max(n,r));const i=e.logResponseDetails;Array.isArray(i)&&i.length>0&&"RETRY_REQUEST_LATER"===i[0].responseAction&&(We=[...t,...We],Ie.info("Retry transport request later.")),ze=3,Je(r)})})({request_time_ms:String(Date.now()),client_info:{client_type:1,js_client_info:{}},log_source:Ce.getInstance().logSource,log_event:t},e).catch(()=>{We=[...e,...We],ze--,Ie.info(`Tries left: ${ze}.`),Je(1e4)})}():Je(1e4)},e)}function Ye(e){return(...t)=>{!function(e){if(!e.eventTime||!e.message)throw _e.create("invalid cc log");We=[...We,e]}({message:e(...t),eventTime:Date.now()})}}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Ze(e,t){Ke||(Ke=Ye(et)),Ke(e,t)}function Qe(e){const t=Ce.getInstance();!t.instrumentationEnabled&&e.isAuto||(t.dataCollectionEnabled||e.isAuto)&&Ne.getInstance().requiredApisAvailable()&&(e.isAuto&&je()!==De.VISIBLE||t.loggingEnabled&&t.logTraceAfterSampling&&(3===qe?Xe(e):Ve().then(()=>Xe(e),()=>Xe(e))))}function Xe(e){ke()&&setTimeout(()=>Ze(e,1),0)}function et(e,t){return 0===t?function(e){const t={url:e.url,http_method:e.httpMethod||0,http_response_code:200,response_payload_bytes:e.responsePayloadBytes,client_start_time_us:e.startTimeUs,time_to_response_initiated_us:e.timeToResponseInitiatedUs,time_to_response_completed_us:e.timeToResponseCompletedUs},n={application_info:tt(),network_request_metric:t};return JSON.stringify(n)}(e):function(e){const t={name:e.name,is_auto:e.isAuto,client_start_time_us:e.startTimeUs,duration_us:e.durationUs};0!==Object.keys(e.counters).length&&(t.counters=e.counters);const n=e.getAttributes();0!==Object.keys(n).length&&(t.custom_attributes=n);const r={application_info:tt(),trace_metric:t};return JSON.stringify(r)}(e)}function tt(){return{google_app_id:Ce.getInstance().getAppId(),app_instance_id:ke(),web_app_info:{sdk_version:"0.4.0-202071902151",page_url:Ne.getInstance().getUrl(),service_worker_status:Pe(),visibility_state:je(),effective_connection_type:Me()},application_process_state:0}}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function ot(){ke()&&(setTimeout(()=>function(){const e=Ne.getInstance(),t=e.getEntriesByType("navigation"),n=e.getEntriesByType("paint");if(e.onFirstInputDelay){let r=setTimeout(()=>{rt.createOobTrace(t,n),r=void 0},5e3);e.onFirstInputDelay(e=>{r&&(clearTimeout(r),rt.createOobTrace(t,n,e))})}else rt.createOobTrace(t,n)}(),0),setTimeout(()=>function(){const e=Ne.getInstance(),t=e.getEntriesByType("resource");for(const e of t)it(e);e.setupObserver("resource",it)}(),0),setTimeout(()=>function(){const e=Ne.getInstance(),t=e.getEntriesByType("measure");for(const e of t)st(e);e.setupObserver("measure",st)}(),0))}function st(e){const t=e.name;"FB-PERF-TRACE-MEASURE"!==t.substring(0,"FB-PERF-TRACE-MEASURE".length)&&rt.createUserTimingTrace(t)}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class at{constructor(e){this.app=e,Ne.getInstance().requiredApisAvailable()&&new Promise((e,t)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=window.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||window.indexedDB.deleteDatabase(r),e(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var e;t((null===(e=i.error)||void 0===e?void 0:e.message)||"")}}catch(e){t(e)}}).then(e=>{e&&(Ge||(Je(5500),Ge=!0),Ve().then(ot,ot))}).catch(e=>{Ie.info("Environment doesn't support IndexedDB: "+e)})}trace(e){return new rt(e)}set instrumentationEnabled(e){Ce.getInstance().instrumentationEnabled=e}get instrumentationEnabled(){return Ce.getInstance().instrumentationEnabled}set dataCollectionEnabled(e){Ce.getInstance().dataCollectionEnabled=e}get dataCollectionEnabled(){return Ce.getInstance().dataCollectionEnabled}}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */!function(e){const t=(e,t)=>{if("[DEFAULT]"!==e.name)throw _e.create("FB not default");if("undefined"==typeof window)throw _e.create("no window");return function(e){Se=e}(window),Ce.getInstance().firebaseAppInstance=e,Ce.getInstance().installationsService=t,new at(e)};e.INTERNAL.registerComponent(new s("performance",e=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("installations").getImmediate();return t(n,r)},"PUBLIC")),e.registerVersion("@firebase/performance","0.4.0-202071902151")}(E);
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return E.registerVersion("firebase","7.19.0-202071902151","lite"),E}));
