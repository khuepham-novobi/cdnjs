(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     */ function F(t = "Unexpected state") {
        ...
        const n = "FIRESTORE (7.17.1) INTERNAL ASSERTION FAILED: " + t;
     ...
     */ function Tt(t) {
        ...
        if (!n.ht) if ("F" /* First */ === n.at) n.ht = yt(n.path, n.collectionGroup, At(n), n.filters, n.limit, n.startAt, n.endAt); else {
            ...
            // We need to swap the cursors to match the now-flipped query ordering.
                    const e = n.endAt ? new Dt(n.endAt.position, !n.endAt.before) : null, r = n.startAt ? new Dt(n.startAt.position, !n.startAt.before) : null;
    ...
    class Rt extends class {} {
         ...
         */    static create(t, n, e) {
            ...
            return "array-contains" /* ARRAY_CONTAINS */ === n ? new Nt(t, e) : "in" /* IN */ === n ? new Ft(t, e) : "not-in" /* NOT_IN */ === n ? new $t(t, e) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new qt(t, e) : new Rt(t, n, e);
        }
        static It(t, n, e) {
    ...
    /** A Filter that implements the array-contains-any operator. */ class qt extends Rt {
        constructor(t, n) {
     ...
     */ class Tn {
        ...
        /** Returns an ObjectValue with all mutations applied. */    Dt() {
    ...
    class Fn {
         ...
         */    async An(t) {
            if (this.yn(), !this.cn) {
                this.cn = !0;
                const n = vn();
                n && n.removeEventListener("visibilitychange", this.wn), await this.In(t);
            }
        }
        /**
         ...
         */    Tn(t) {
            this.an.push(t), this.on(() => this.Pn());
        }
        /**
     ...
     */ (t)), t;
         ...
         */    Ht(t, n, e) {
            ...
            const r = Nn.en(this, t, n, e, t => this.Rn(t));
        ...
        /** Called once a DelayedOperation is run or canceled. */    Rn(t) {
    ...
    class $n extends class {} {
        constructor(t, n) {
            super(), this.credentials = t, this.serializer = n, this.Fn = !1;
        }
        $n() {
        ...
        /** Gets an auth token and invokes the provided RPC. */    Dn(t, n, e) {
            return this.$n(), this.credentials.getToken().then(r => this.qn.Dn(t, n, e, r)).catch(t => {
                throw t.code === w && this.credentials.R(), t;
            });
        }
        /** Gets an auth token and invokes the provided RPC with streamed results. */    xn(t, n, e) {
            return this.$n(), this.credentials.getToken().then(r => this.qn.xn(t, n, e, r)).catch(t => {
                throw t.code === w && this.credentials.R(), t;
            });
        }
        async Sn() {
    ...
    async function qn(t, n) {
        const e = q(t), r = Zt(e.serializer) + "/documents", s = {
    ...
    async function Dn(t, n) {
        ...
        }, i = await e.xn("BatchGetDocuments", r, s), o = new Map;
        i.forEach(t => {
    ...
    async function xn(t, n) {
        const e = q(t), r = nn(e.serializer, Tt(n));
        return (await e.xn("RunQuery", r.parent, {
    ...
    class {
        constructor(t) {
            this.On = t, this.s = t.s;
            const n = t.ssl ? "https" : "http";
            this.Cn = n + "://" + t.host, this.Un = "projects/" + this.s.projectId + "/databases/" + this.s.database + "/documents";
        }
        Dn(t, n, e, r) {
            const s = this.Ln(t, n);
            g("RestConnection", "Sending: ", s, e);
            const i = {};
            return this.Bn(i, r), this.Mn(t, s, i, e).then(t => (g("RestConnection", "Received: ", t), 
            t), n => {
                throw function(t, ...n) {
                    if (V.logLevel <= LogLevel.WARN) {
                        const e = n.map(N);
                        V.warn("Firestore (7.17.1): " + t, ...e);
                    }
    ...
    function Ln(t) {
        var n, e;
        if (t.Qn) throw new R(p, "The client has already been terminated.");
        if (!Un.has(t)) {
            g("ComponentProvider", "Initializing Datastore");
            const r = t.Gn(), s = new C(t.Wn, t.Yn, null !== (n = r.host) && void 0 !== n ? n : "firestore.googleapis.com", null === (e = r.ssl) || void 0 === e || e, 
            /* forceLongPolling= */ !1), i = function(t) {
                return Promise.resolve(new On(t, fetch.bind(null)));
            }(s).then(n => {
                const e = Cn(s.s), r = function(t, n) {
                    return new $n(t, n);
                }(t.zn, e);
                return r.start(n), r;
            });
    ...
    class Bn {
        constructor(t, n) {
            this.app = t, this.Yn = "(lite)", this.Hn = !1, 
            // TODO(firestoreexp): `deleteApp()` should call the delete method above,
            // but it still calls INTERNAL.delete().
            this.INTERNAL = {
                delete: () => this.delete()
            }, this.Wn = Bn.Kn(t), this.zn = new M(n);
        }
        get Zn() {
            return this.Hn;
        }
        get Qn() {
            return void 0 !== this.Jn;
        }
        Xn(t) {
            if (this.Hn) throw new R(p, "Firestore has already been started and its settings can no longer be changed. initializeFirestore() cannot be called after calling getFirestore().");
            this.te = t;
        }
        Gn() {
            return this.te || (this.te = {}), this.Hn = !0, this.te;
        }
        static Kn(t) {
        ...
        delete() {
            return this.Jn || (this.Jn = this.ne()), this.Jn;
        }
        /**
         ...
         */    ne() {
            return async function(t) {
                const n = await Un.get(t);
                if (n) return g("ComponentProvider", "Removing Datastore"), Un.delete(t), (await n).Sn();
            }(this);
        }
    }
     ...
     */ class re {
        ...
        toBase64() {
            return Qn("Blob.toBase64", arguments, 0), ee(), this.ee.toBase64();
        }
        toUint8Array() {
            return Qn("Blob.toUint8Array", arguments, 0), ne(), this.ee.toUint8Array();
        }
        toString() {
            return "Blob(base64: " + this.toBase64() + ")";
        }
        isEqual(t) {
            return this.ee.isEqual(t.ee);
        }
    }
    ...
    class ae extends ue {
        ...
        oe(t) {
            if (2 /* MergeSet */ !== t.ue) throw 1 /* Update */ === t.ue ? t.ae(this.ie + "() can only appear at the top level of your update data") : t.ae(this.ie + "() cannot be used with set() unless you pass {merge:true}");
    ...
    class le extends ue {
        constructor(t, n) {
            super(), this.ie = t, this.le = n;
        }
        oe(t) {
            const n = ce(this, t, 
            /*array=*/ !0), e = this.le.map(t => be(t, n)), r = new cn(e);
    ...
    class fe extends ue {
        ...
        oe(t) {
            const n = ce(this, t, 
            /*array=*/ !0), e = this.le.map(t => be(t, n)), r = new hn(e);
            return new dn(t.path, r);
        }
        isEqual(t) {
            // TODO(mrschmidt): Implement isEquals
    ...
    class de extends ue {
        constructor(t, n) {
            super(), this.ie = t, this.fe = n;
        }
        oe(t) {
            const n = new ln(t.serializer, kt(t.serializer, this.fe));
     ...
     */ class _e {
        ...
        isEqual(t) {
            return this.de === t.de && this._e === t._e;
        }
        /**
         * Actually private to JS consumers of our API, so this function is prefixed
         * with an underscore.
         */    v(t) {
            return S(this.de, t.de) || S(this._e, t._e);
        }
    }
    ...
    /** A "context" object passed around while parsing user data. */ class Ie {
        ...
        constructor(t, n, e, r, s, i) {
            ...
            void 0 === s && this.ye(), this.fieldTransforms = s || [], this.Pt = i || [];
        }
        get path() {
            return this.settings.path;
        }
        get ue() {
            return this.settings.ue;
        }
        /** Returns a new context with the specified settings overwritten. */    Ee(t) {
        ...
        Ie(t) {
            var n;
            const e = null === (n = this.path) || void 0 === n ? void 0 : n.child(t), r = this.Ee({
                path: e,
                he: !1
            });
            return r.Ae(t), r;
        ...
        ae(t) {
            return qe(t, this.settings.methodName, this.settings.Re || !1, this.path, this.settings.ce);
        }
        ...
        ye() {
            ...
            // within arrays.
            if (this.path) for (let t = 0; t < this.path.length; t++) this.Ae(this.path.get(t));
        }
        Ae(t) {
            if (0 === t.length) throw this.ae("Document fields must not be empty");
            if (Ee(this.ue) && we.test(t)) throw this.ae('Document fields cannot begin and end with "__"');
        }
    }
     ...
     */ class Ae {
        ...
        /** Creates a new top-level parse context. */    Ve(t, n, e, r = !1) {
            return new Ie({
                ue: t,
                methodName: n,
                ce: e,
    ...
    /** Parse document data from a set() call. */ function Te(t, n, e, r, s, i = {}) {
        const o = t.Ve(i.merge || i.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , n, e, s);
        ...
        if (i.merge) a = new fn(o.Pt), c = o.fieldTransforms; else if (i.mergeFields) {
            ...
            for (const r of i.mergeFields) {
                let s;
                if (r instanceof se) s = r.re; else {
    ...
    /** Parse update data from an update() call. */ function Pe(t, n, e, r) {
        const s = t.Ve(1 /* Update */ , n, e);
        Ne("Data must be an object, but it was:", s, r);
        const i = [], o = new Tn;
        Z(r, (t, r) => {
            const u = $e(n, t, e), a = s.Te(u);
            if (r instanceof ue && r.se instanceof ae) 
        ...
        const u = new fn(i);
        return new ye(o.Dt(), u, s.fieldTransforms);
    }

    /** Parse update data from a list of field/value arguments. */ function Re(t, n, e, r, s, i) {
        const o = t.Ve(1 /* Update */ , n, e), u = [ Fe(n, r, e) ], a = [ s ];
        ...
        for (let t = u.length - 1; t >= 0; --t) if (!De(c, u[t])) {
            const n = u[t], e = a[t], r = o.Te(n);
            if (e instanceof ue && e.se instanceof ae) 
            // Add it to the field mask, but don't add anything to updateData.
            c.push(n); else {
                const t = be(e, r);
        ...
        const f = new fn(c);
        return new ye(l.Dt(), f, o.fieldTransforms);
    }
     ...
     */ function Ve(t, n, e, r = !1) {
        return be(e, t.Ve(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , n));
    }
     ...
     */
        return function(t, n) {
            ...
            if (!Ee(n.ue)) throw n.ae(t.ie + "() can only be used with update() and set()");
            if (!n.path) throw n.ae(t.ie + "() is not currently supported inside arrays");
            const e = t.oe(n);
     ...
     */ (t, n), null;
        ...
        n.path && n.Pt.push(n.path), t instanceof Array) {
            ...
            if (n.settings.he && 4 /* ArrayArgument */ !== n.ue) throw n.ae("Nested arrays are not supported");
            return function(t, n) {
                const e = [];
                let r = 0;
                for (const s of t) {
        ...
        return function(t, n) {
            ...
            if (t instanceof me) {
                const e = n.s, r = t.Wn;
                if (!r.isEqual(e)) throw n.ae(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${e.projectId}/${e.database}`);
                return {
                    referenceValue: Yt(t.Wn || n.s, t.we.path)
                };
            }
            if (void 0 === t && n.ignoreUndefinedProperties) return null;
            throw n.ae("Unsupported field value: " + Kn(t));
            var e, r;
        }
        /**
    ...
    function Ne(t, n, e) {
        if (!ve(e) || !Hn(e)) {
            const r = Kn(e);
            throw "an object" === r ? n.ae(t + " a custom object") : n.ae(t + " " + r);
        }
    }
     ...
     */ function Fe(t, n, e) {
        if (n instanceof se) return n.re;
     ...
     */ class Oe {
        constructor(t, n, e, r) {
            this.s = t, this.timestampsInSnapshots = n, this.be = e, this.ge = r;
        }
        ve(t) {
            switch (st(t)) {
              case 0 /* NullValue */ :
              ...
              case 3 /* TimestampValue */ :
                return this.Ne(t.timestampValue);
              ...
              case 7 /* RefValue */ :
                return this.$e(t.referenceValue);

              case 8 /* GeoPointValue */ :
                return this.qe(t.geoPointValue);

              case 9 /* ArrayValue */ :
                return this.De(t.arrayValue);

              case 10 /* ObjectValue */ :
                return this.xe(t.mapValue);
        ...
        De(t) {
            return (t.values || []).map(t => this.ve(t));
        }
        Fe(t) {
            switch (this.be) {
              case "previous":
     ...
     */ class Ce {
        ...
        constructor(t, n, e, r) {
            this.Se = t, this.we = n, this.Oe = e, this.me = r;
        }
        get id() {
            return this.we.path.L();
        }
        get ref() {
            return new Ke(this.Se, this.me, this.we.path);
        }
        exists() {
            return null !== this.Oe;
        }
        data() {
            if (this.Oe) {
                if (this.me) {
                    ...
                    const t = new Ue(this.Se, this.we, this.Oe, 
                    /* converter= */ null);
                    return this.me.fromFirestore(t);
                }
                return new Oe(this.Se.Wn, 
                /* timestampsInSnapshots= */ !0, 
                /* serverTimestampBehavior=*/ "none", t => new Ke(this.Se, 
                /* converter= */ null, t.path)).ve(this.Oe.Ct());
            }
        }
        get(t) {
            if (this.Oe) {
                const n = this.Oe.data().field(Me("DocumentSnapshot.get", t));
                if (null !== n) {
                    return new Oe(this.Se.Wn, 
                    /* timestampsInSnapshots= */ !0, 
                    /* serverTimestampBehavior=*/ "none", t => new Ke(this.Se, this.me, t.path)).ve(n);
                }
            }
        }
    }
    ...
    function Be(t, n) {
        return t instanceof Ce && n instanceof Ce ? t.Se === n.Se && t.we.isEqual(n.we) && (null === t.Oe ? null === n.Oe : t.Oe.isEqual(n.Oe)) && t.me === n.me : t instanceof Le && n instanceof Le && (br(t.query, n.query) && O(t.docs, n.docs, Be));
    }
     ...
     */ class je {
        constructor(t) {
            ...
            this.Le = new Map, this.mutations = [], this.Be = !1, 
            /**
        ...
        async ke(t) {
            if (this.Qe(), this.mutations.length > 0) throw new R(h, "Firestore transactions require all reads to be executed before all writes.");
            const n = await Dn(this.Ue, t);
            return n.forEach(t => {
                t instanceof Vn || t instanceof Rn ? this.Ge(t) : F();
            }), n;
        }
        set(t, n) {
            this.write(n.pe(t, this.bt(t))), this.je.add(t);
        }
        update(t, n) {
            try {
                this.write(n.pe(t, this.We(t)));
            } catch (t) {
                this.Me = t;
            }
            this.je.add(t);
        ...
        delete(t) {
            this.write([ new En(t, this.bt(t)) ]), this.je.add(t);
        }
        async commit() {
            if (this.Qe(), this.Me) throw this.Me;
            const t = this.Le;
            ...
            }), await qn(this.Ue, this.mutations), this.Be = !0;
        }
        Ge(t) {
            let n;
            ...
            const e = this.Le.get(t.key.toString());
            if (e) {
                if (!n.isEqual(e)) 
                // This transaction will fail no matter what.
                throw new R(y, "Document version changed between two reads.");
            } else this.Le.set(t.key.toString(), n);
        }
        /**
         * Returns the version of this document when it was read in this transaction,
         * as a precondition, or no precondition if it was not read.
         */    bt(t) {
            const n = this.Le.get(t.toString());
            return !this.je.has(t) && n ? _n.updateTime(n) : _n.Nt();
        }
        /**
        ...
        write(t) {
            this.Qe(), this.mutations = this.mutations.concat(t);
        }
        Qe() {}
    }
    ...
    class ke {
        constructor(t, n, e, r) {
            this.Jt = t, this.Ue = n, this.updateFunction = e, this.nn = r, this.Ye = 5, this._n = new gn(this.Jt, "transaction_retry" /* TransactionRetry */);
        }
        ...
        ze() {
            this._n.Yt(async () => {
                const t = new je(this.Ue), n = this.He(t);
                n && n.then(n => {
        ...
        Ke(t) {
            this.Ye > 0 && this.Ze(t) ? (this.Ye -= 1, this.Jt.on(() => (this.ze(), Promise.resolve()))) : this.nn.reject(t);
        }
        Ze(t) {
    ...
    function We(t, n, e) {
        ...
        if (e instanceof me) return ft(t, e.we);
     ...
     */ class Ke extends me {
        constructor(t, n, e) {
            super(t.Wn, new H(e), n), this.firestore = t, this.converter = n, this.Je = e, this.type = "document";
        }
        get id() {
            return this.Je.L();
        }
        ...
        withConverter(t) {
            return new Ke(this.firestore, t, this.Je);
        }
    }
    ...
    class Ze {
        ...
        constructor(t, n, e) {
            this.firestore = t, this.converter = n, this.Xe = e, this.type = "query";
        }
        withConverter(t) {
            return new Ze(this.firestore, t, this.Xe);
        }
    }
    ...
    class tr extends Je {
        constructor(t, n, e) {
            super(), this.tr = t, this.nr = n, this.er = e, this.type = "where";
        }
        apply(t) {
            const n = gr(t.firestore), e = Qe(t.Xe, "where", n, t.firestore.Wn, this.tr, this.nr, this.er);
    ...
    class er extends Je {
        constructor(t, n) {
            super(), this.tr = t, this.rr = n, this.type = "orderBy";
        }
        apply(t) {
            const n = Ge(t.Xe, this.tr, this.rr);
            return new Ze(t.firestore, t.converter, function(t, n) {
    ...
    class sr extends Je {
        constructor(t, n, e) {
            super(), this.type = t, this.sr = n, this.ir = e;
        }
        apply(t) {
    ...
    class ur extends Je {
        constructor(t, n, e) {
            super(), this.type = t, this.or = n, this.ur = e;
        }
        apply(t) {
            const n = dr(t, this.type, this.or, this.ur);
            return new Ze(t.firestore, t.converter, function(t, n) {
     ...
     */ (t.Xe, t.firestore.Wn, n, e[0].Oe, r);
        {
            ...
            return function(t, n, e, r, s, i) {
                ...
                return new Dt(u, i);
            }(t.Xe, t.firestore.Wn, s, n, e, r);
        }
    }

    class _r extends Ze {
        constructor(t, n, e) {
            super(t, e, new Et(n)), this.firestore = t, this.Je = n, this.type = "collection";
        }
        get id() {
            return this.Xe.path.L();
        }
        get path() {
            return this.Xe.path.G();
        }
        withConverter(t) {
            return new _r(this.firestore, this.Je, t);
        }
    }
    ...
    function yr(t) {
        ...
        {
            const n = j(t, Ke);
            return new _r(n.firestore, n.we.path.C(), n.me);
        }
    }

    function Er(t) {
        const n = j(t, Ke);
        return Ln(n.firestore).then(async t => {
            const e = await Dn(t, [ n.we ]);
            $(1 === e.length);
            const r = e[0];
            return new Ce(n.firestore, n.we, r instanceof Rn ? r : null, n.me);
        });
    }
    ...
    function Ir(t) {
        ...
        }(n.Xe), Ln(n.firestore).then(async e => {
            const r = (await xn(e, n.Xe)).map(t => new Ue(n.firestore, t.key, t, n.converter));
            return n.Xe._t() && 
    ...
    function Ar(t, n, e) {
        const r = j(t, Ke), s = He(r.me, n, e), i = Te(gr(r.firestore), "setDoc", r.we, s, null !== r.me, e);
        return Ln(r.firestore).then(t => qn(t, i.pe(r.we, _n.Nt())));
    }

    function Tr(t, n, e, ...r) {
        const s = j(t, Ke), i = gr(s.firestore);
        let o;
        return o = "string" == typeof n || n instanceof xe ? Re(i, "updateDoc", s.we, n, e, r) : Pe(i, "updateDoc", s.we, n), 
        Ln(s.firestore).then(t => qn(t, o.pe(s.we, _n.exists(!0))));
    }

    function Pr(t) {
        const n = j(t, Ke);
        return Ln(n.firestore).then(t => qn(t, [ new En(n.we, _n.Nt()) ]));
    }

    function Rr(t, n) {
        const e = j(t, _r), r = pr(e), s = He(e.converter, n), i = Te(gr(e.firestore), "addDoc", r.we, s, null !== r.me, {});
        return Ln(e.firestore).then(t => qn(t, i.pe(r.we, _n.exists(!1)))).then(() => r);
    }
    ...
    function br(t, n) {
        return t instanceof Ze && n instanceof Ze && (t.firestore === n.firestore && Pt(t.Xe, n.Xe) && t.converter === n.converter);
    }

    function gr(t) {
        const n = t.Gn(), e = Cn(t.Wn);
        return new Ae(t.Wn, !!n.ignoreUndefinedProperties, e);
    }
     ...
     */ class Nr extends vr {
        constructor(t) {
            super(), this.se = t, this.ie = t.ie;
        }
        oe(t) {
            return this.se.oe(t);
        }
        isEqual(t) {
            return t instanceof Nr && this.se.isEqual(t.se);
        }
    }
     ...
     */ class Sr {
        constructor(t, n) {
            this.Se = t, this.ar = n, this.cr = [], this.hr = !1, this.lr = gr(t);
        }
        set(t, n, e) {
            this.dr();
            const r = Or(t, this.Se), s = He(r.me, n, e), i = Te(this.lr, "WriteBatch.set", r.we, s, null !== r.me, e);
            return this.cr = this.cr.concat(i.pe(r.we, _n.Nt())), this;
        }
        update(t, n, e, ...r) {
            this.dr();
            const s = Or(t, this.Se);
            let i;
            return i = "string" == typeof n || n instanceof xe ? Re(this.lr, "WriteBatch.update", s.we, n, e, r) : Pe(this.lr, "WriteBatch.update", s.we, n), 
            this.cr = this.cr.concat(i.pe(s.we, _n.exists(!0))), this;
        }
        delete(t) {
            this.dr();
            const n = Or(t, this.Se);
            return this.cr = this.cr.concat(new En(n.we, _n.Nt())), this;
        }
        commit() {
            return this.dr(), this.hr = !0, this.cr.length > 0 ? this.ar(this.cr) : Promise.resolve();
        }
        dr() {
            if (this.hr) throw new R(p, "A write batch can no longer be used after commit() has been called.");
        }
    }
    ...
    function Cr(t) {
        const n = j(t, Bn);
        return new Sr(n, t => Ln(n).then(n => qn(n, t)));
    }
    ...
    class Ur {
        constructor(t, n) {
            this.Se = t, this._r = n, this.lr = gr(t);
        }
        get(t) {
            const n = Or(t, this.Se);
            return this._r.ke([ n.we ]).then(t => {
                if (!t || 1 !== t.length) return F();
                const e = t[0];
                if (e instanceof Vn) return new Ce(this.Se, n.we, null, n.me);
                if (e instanceof Rn) return new Ce(this.Se, e.key, e, n.me);
                throw F();
            });
        }
        set(t, n, e) {
            const r = Or(t, this.Se), s = He(r.me, n, e), i = Te(this.lr, "Transaction.set", r.we, s, null !== r.me, e);
            return this._r.set(r.we, i), this;
        }
        update(t, n, e, ...r) {
            const s = Or(t, this.Se);
            let i;
            return i = "string" == typeof n || n instanceof xe ? Re(this.lr, "Transaction.update", s.we, n, e, r) : Pe(this.lr, "Transaction.update", s.we, n), 
            this._r.update(s.we, i), this;
        }
        delete(t) {
            const n = Or(t, this.Se);
            return this._r.delete(n.we), this;
        }
    }

    function Lr(t, n) {
        const e = j(t, Bn);
        return Ln(e).then(async t => {
            const r = new bn;
            return new ke(new Fn, t, t => n(new Ur(e, t)), r).run(), r.promise;
        });
    }
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */ app._registerComponent(new Component("firestore/lite", t => ((t, n) => new Bn(t, n))(t.getProvider("app-exp").getImmediate(), t.getProvider("auth-internal")), "PUBLIC" /* PUBLIC */)), 
    app.registerVersion("firestore-lite", "0.0.800", "node");

    exports.Blob = re;
    exports.CollectionReference = _r;
    exports.DocumentReference = Ke;
    exports.DocumentSnapshot = Ce;
    exports.FieldPath = xe;
    exports.FieldValue = vr;
    exports.FirebaseFirestore = Bn;
    exports.GeoPoint = _e;
    exports.Query = Ze;
    exports.QueryConstraint = Je;
    exports.QueryDocumentSnapshot = Ue;
    exports.QuerySnapshot = Le;
    exports.Timestamp = k;
    exports.Transaction = Ur;
    exports.WriteBatch = Sr;
    exports.addDoc = Rr;
    exports.arrayRemove = Dr;
    exports.arrayUnion = qr;
    exports.collection = wr;
    exports.collectionGroup = mr;
    exports.deleteDoc = Pr;
    exports.deleteField = Fr;
    exports.doc = pr;
    exports.documentId = Se;
    exports.endAt = fr;
    exports.endBefore = lr;
    exports.getDoc = Er;
    exports.getDocs = Ir;
    exports.getFirestore = jn;
    exports.increment = xr;
    exports.initializeFirestore = Mn;
    exports.limit = ir;
    exports.limitToLast = or;
    exports.orderBy = rr;
    exports.parent = yr;
    exports.query = Xe;
    exports.queryEqual = br;
    exports.refEqual = Vr;
    exports.runTransaction = Lr;
    exports.serverTimestamp = $r;
    exports.setDoc = Ar;
    exports.setLogLevel = b;
    exports.snapshotEqual = Be;
    exports.startAfter = cr;
    exports.startAt = ar;
    exports.terminate = kn;
