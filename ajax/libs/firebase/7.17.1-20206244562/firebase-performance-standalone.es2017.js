...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const ne="firebase-installations-store";let re=null;function ie(){return re||(re=function(e,t,n){var r=A(indexedDB,"open",[e,t]),i=r.request;return i&&(i.onupgradeneeded=function(e){n&&n(new M(i.result,e.oldVersion,i.transaction))}),r.then((function(e){return new $(e)}))}("firebase-installations-database",1,e=>{switch(e.oldVersion){case 0:e.createObjectStore(ne)}})),re}async function oe(e,t){const n=J(e),r=(await ie()).transaction(ne,"readwrite"),i=r.objectStore(ne),o=await i.get(n);return await i.put(t,n),await r.complete,o&&o.fid===t.fid||Z(e,t.fid),t}async function se(e){const t=J(e),n=(await ie()).transaction(ne,"readwrite");await n.objectStore(ne).delete(t),await n.complete}async function ae(e,t){const n=J(e),r=(await ie()).transaction(ne,"readwrite"),i=r.objectStore(ne),o=await i.get(n),s=t(o);return void 0===s?await i.delete(n):await i.put(s,n),await r.complete,!s||o&&o.fid===s.fid||Z(e,s.fid),s}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
async function me(e,t=!1){return await async function(e){const{registrationPromise:t}=await ce(e);t&&await t}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e.appConfig),(await he(e,t)).token}async function be(e,t){const n=function(e,{fid:t}){return`${B(e)}/${t}`}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
const $e=!0;function Fe(e){const t=function(){const e=Ae.getInstance().localStorage;if(!e)return;const t=e.getItem("@firebase/performance/configexpire");if(!(t&&(n=t,Number(n)>Date.now())))return;var n;const r=e.getItem("@firebase/performance/config");if(!r)return;try{return JSON.parse(r)}catch(e){return}}();return t?(Ue(t),Promise.resolve()):function(e){return function(){const e=Oe.getInstance().installationsService.getToken();return e.then(e=>{}),e}().then(t=>{const n=`https://firebaseremoteconfig.googleapis.com/v1/projects/${Oe.getInstance().getProjectId()}/namespaces/fireperf:fetch?key=${Oe.getInstance().getApiKey()}`,r=new Request(n,{method:"POST",headers:{Authorization:`FIREBASE_INSTALLATIONS_AUTH ${t}`},body:JSON.stringify({app_instance_id:e,app_instance_id_token:t,app_id:Oe.getInstance().getAppId(),app_version:"0.3.10-20206244562",sdk_version:"0.0.1"})});return fetch(r).then(e=>{if(e.ok)return e.json();throw _e.create("RC response not ok")})}).catch(()=>{Me.info("Could not fetch config, will use default configs")})}(e).then(Ue).then(e=>function(e){const t=Ae.getInstance().localStorage;if(!e||!t)return;t.setItem("@firebase/performance/config",JSON.stringify(e)),t.setItem("@firebase/performance/configexpire",String(Date.now()+60*Oe.getInstance().configTimeToLive*60*1e3))}(e),()=>{})}function Ue(e){if(!e)return e;const t=Oe.getInstance(),n=e.entries||{};return void 0!==n.fpr_enabled?t.loggingEnabled="true"===String(n.fpr_enabled):t.loggingEnabled=$e,n.fpr_log_source&&(t.logSource=Number(n.fpr_log_source)),n.fpr_log_endpoint_url&&(t.logEndPointUrl=n.fpr_log_endpoint_url),n.fpr_log_transport_key&&(t.transportKey=n.fpr_log_transport_key),void 0!==n.fpr_vc_network_request_sampling_rate&&(t.networkRequestsSamplingRate=Number(n.fpr_vc_network_request_sampling_rate)),void 0!==n.fpr_vc_trace_sampling_rate&&(t.tracesSamplingRate=Number(n.fpr_vc_trace_sampling_rate)),t.logTraceAfterSampling=Be(t.tracesSamplingRate),t.logNetworkAfterSampling=Be(t.networkRequestsSamplingRate),e}function Be(e){return Math.random()<=e}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let qe,xe=1;function Ve(){return xe=2,qe=qe||function(){const e=Ae.getInstance().document;return new Promise(t=>{if(e&&"complete"!==e.readyState){const n=()=>{"complete"===e.readyState&&(e.removeEventListener("readystatechange",n),t())};e.addEventListener("readystatechange",n)}else t()})}().then(()=>function(){const e=Oe.getInstance().installationsService.getId();return e.then(e=>{Te=e}),e}()).then(e=>Fe(e)).then(()=>He(),()=>He()),qe}function He(){xe=3}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */!function(e){const t=(e,t)=>{if("[DEFAULT]"!==e.name)throw _e.create("FB not default");if("undefined"==typeof window)throw _e.create("no window");return function(e){Ee=e}(window),Oe.getInstance().firebaseAppInstance=e,Oe.getInstance().installationsService=t,new at(e)};e.INTERNAL.registerComponent(new s("performance",e=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("installations").getImmediate();return t(n,r)},"PUBLIC")),e.registerVersion("@firebase/performance","0.3.10-20206244562")}(E);
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return E.registerVersion("firebase","7.17.1-20206244562","lite"),E}));
