(function UMDBundle(context, umdDefs) {
  ...
  function Maybe(val) {
    ...
    function _inspect() {
      return `${publicAPI[Symbol.toStringTag]}(${isJust ? typeof val == "string" ? JSON.stringify(val) : typeof val == "undefined" ? "" : typeof val == "function" ? val.name || "anonymous function" : val && typeof val._inspect == "function" ? val._inspect() : val : ""})`;
    }
  ...
  var brand = {};
  var publicAPI = Object.assign(IO, {
    of,
    is,
    do: $do,
    doEither
