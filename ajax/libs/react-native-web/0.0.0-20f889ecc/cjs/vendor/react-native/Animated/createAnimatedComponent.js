...
function createAnimatedComponent(Component, defaultProps) {
  ...
  function (_React$Component) {
    ...
    _proto._setComponentRef = function _setComponentRef() {
      var _this3 = this;

      var setLocalRef = function setLocalRef(ref) {
        _this3._prevComponent = _this3._component;
        _this3._component = ref; // TODO: Delete this in a future release.
      ...
      (0, _mergeRefs.default)(this.props.forwardedRef, setLocalRef);
    };
