...
var emptyArray = [];
/**
 * The `touchBank` array in the RN responder event API can create enormous
 * arrays if a browser (like Safari) uses large integers as identifiers.
 * This normalizes the identifiers to 0-20
 */
...
function createResponderEvent(domEvent) {
  ...
  function normalizeTouches(touches) {
    return Array.prototype.slice.call(touches).map(function (touch) {
      touch.identifier = normalizeIdentifier(touch.identifier);
