...
var drag = {
    ...
    drag: function (mouse) {
        ...
        var minY = config.data_selection_grouped ? state.margin.top : Math.min(sy, my);
        var maxY = config.data_selection_grouped ? state.height : Math.max(sy, my);
        ...
        main.selectAll("." + CLASS.shapes)
            ...
            .filter(function (d) { return config.data_selection_isselectable.bind($$.api)(d); })
            .each(function (d, i) {
...
var shapeArc = {
    ...
    redrawArc: function (duration, durationForExit, withTransform) {
        ...
        mainArc = mainArc.enter().append("path")
            ...
            .style("cursor", function (d) { return (hasInteraction && config.data_selection_isselectable.bind($$.api)(d) ? "pointer" : null); })
            .style("opacity", "0")
            .each(function (d) {
...
var shapeBar = {
    ...
    updateTargetsForBar: function (targets) {
        ...
        mainBarEnter.append("g")
            ...
            .style("cursor", function (d) { return (config.data_selection_isselectable.bind($$.api)(d) ? "pointer" : null); });
    },
...
var shapePoint = {
    ...
    updateTargetForCircle: function (targetsValue, enterNodeValue) {
        ...
        var selectionEnabled = config.data_selection_enabled;
