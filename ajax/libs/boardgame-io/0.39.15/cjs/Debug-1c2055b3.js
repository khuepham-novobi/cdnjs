...
function instance$1($$self, $$props, $$invalidate) {
  ...
  const { disableHotkeys } = svelte.getContext('hotkeys'); component_subscribe($$self, disableHotkeys, $$value => { $disableHotkeys = $$value; $$invalidate('$disableHotkeys', $disableHotkeys); });
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  const {disableHotkeys} = svelte.getContext('hotkeys');
...
function instance$i($$self, $$props, $$invalidate) {
  ...
  const { secondaryPane } = svelte.getContext('secondaryPane');
  ...
  let phaseBoundaries = {};
	...
	$$self.$$.update = ($$dirty = { $client: 1, log: 1, renderedLogEntries: 1 }) => {
        ...
        $$invalidate('renderedLogEntries', renderedLogEntries = log.filter(e => e.action.type == turnOrder.MAKE_MOVE));
...
function instance$k($$self, $$props, $$invalidate) {
  ...
  let bot;
  if (client.game.ai) {
    $$invalidate('bot', bot = new ai.MCTSBot({
      game: client.game,
...
function instance$l($$self, $$props, $$invalidate) {
  ...
  svelte.setContext('hotkeys', { disableHotkeys });
  svelte.setContext('secondaryPane', { secondaryPane });
