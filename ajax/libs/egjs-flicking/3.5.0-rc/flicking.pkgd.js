...
(function (global, factory) {
    ...
    */
    ...
    function filter$1(obj, callback) {
      var filtered = {};
    ...
    function () {
      ...
      __proto.setTo = function (pos, duration) {
        ...
        var movedPos = filter$1(pos, function (v, k) {
          return orgPos[k] !== v;
        });
    ...
    function () {
      ...
      __proto.filter = function (pos, callback) {
        var axisOptions = this.axis;
        return filter$1(pos, function (value, key) {
          return callback(value, axisOptions[key], key);
        });
      };
    ...
    var IS_IOS_SAFARI = "ontouchstart" in win$2 && agent(win$2.navigator.userAgent).browser.name.indexOf("safari") > -1;
    ...
    **/
    ...
    var SUPPORT_TOUCH$1 = "ontouchstart" in win$2;
