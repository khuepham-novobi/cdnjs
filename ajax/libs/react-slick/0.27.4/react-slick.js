...
var slideHandler = function slideHandler(spec) {
  ...
  var state = {},
      nextState = {};
  var targetSlide = infinite ? index : clamp(index, 0, slideCount);
