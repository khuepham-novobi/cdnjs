...
LanguageModel.prototype.formatString = function formatString (string) {
  ...
  return string.replace(/:(\w+)/g, function (match, word) {
    if (this$1[word]) {
      return '<span class="f-uppercase">' + this$1[word] + '</span>'
    }
...
var isMobile = !!(typeof navigator !== 'undefined' && navigator.userAgent.match(/android|iphone|ipad|ipod/i));
...
var __vue_render__$6 = function() {
  ...
  return _vm.question.content
    ? _c("div", { staticClass: "f-content" }, [
        _c("span", { staticClass: "section-text" }, [
...
var __vue_render__$7 = function() {
  ...
  return _c(
    "div",
    { ref: "qanimate", staticClass: "animate q-form", class: _vm.mainClasses },
    [
      _c("div", { staticClass: "q-inner" }, [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm.question.description || _vm.question.descriptionLink
              ? _c(
                  "p",
        ...
        _vm._v(" "),
        _vm.showOkButton()
          ? _c("div", { staticClass: "animate fade-in f-enter" }, [
              _c(
                "button",
                {
                  ref: "button",
...
var script$e = {
  name: 'FlowForm',
  components: {
    FlowFormQuestion: __vue_component__$d
  },
  props: {
    questions: Array,
    language: {
...
function install(Vue) {
  ...
  Vue.component('FlowForm', __vue_component__$e);
}
...
export default __vue_component__$e;
export { ChoiceOption, LanguageModel, LinkOption, QuestionModel, QuestionType, install };
