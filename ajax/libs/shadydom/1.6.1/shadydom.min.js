...
$a.activeElement),z(Window.prototype,rc,"__shady_"),u.g||(uc(),Xb()),Sb(),window.Event=Ub,window.CustomEvent=Vb,window.MouseEvent=Wb,window.ShadowRoot=N);}).call(this);
