(function (global, factory) {
    ...
    var NgbAccordionConfig = /** @class */ (function () {
        function NgbAccordionConfig(ngbConfig) {
    ...
    var ngbRunTransition = function (element, startFn, options) {
        ...
        runningTransitions.set(element, { transition$: transition$, context: context });
        ...
        var transitionEnd$ = rxjs.fromEvent(element, 'transitionend').pipe(operators.takeUntil(stop$), operators.filter(function (_a) {
            var target = _a.target;
            return target === element;
        }));
        var timer$ = rxjs.timer(transitionDurationMs + transitionTimerDelayMs).pipe(operators.takeUntil(stop$));
        rxjs.race(timer$, transitionEnd$).pipe(operators.takeUntil(stop$)).subscribe(function () {
            runningTransitions.delete(element);
            endFn();
            transition$.next();
            transition$.complete();
    ...
    var NgbAlertConfig = /** @class */ (function () {
        function NgbAlertConfig(ngbConfig) {
    ...
    var ngbNavFadeInNoReflowTransition = function (element) {
        element.classList.add('active');
        element.classList.add('show');
    };
    ...
    ***************************************************************************** */
    ...
    var NgbCarouselConfig = /** @class */ (function () {
        function NgbCarouselConfig(ngbConfig) {
            this.interval = 5000;
            this.wrap = true;
            this.keyboard = true;
            ...
            if (i1.isPlatformBrowser(this._platformId)) {
                this._ngZone.runOutsideAngular(function () {
                    ...
                    rxjs.combineLatest([
                        ...
                        .pipe(operators.map(function (_a) {
                        var _b = __read(_a, 7), pause = _b[0], pauseOnHover = _b[1], mouseHover = _b[2], pauseOnFocus = _b[3], focused = _b[4], interval = _b[5], hasNextSlide = _b[6];
    ...
    var NgbCollapseConfig = /** @class */ (function () {
        function NgbCollapseConfig(ngbConfig) {
            this.animation = ngbConfig.animation;
        }
    ...
    */
    var NgbModalConfig = /** @class */ (function () {
        function NgbModalConfig(ngbConfig) {
            this.backdrop = true;
            this.keyboard = true;
            this.animation = ngbConfig.animation;
        }
    ...
    var PopupService = /** @class */ (function () {
        ...
        PopupService.prototype.open = function (content, context, animation) {
            ...
            var transition$ = onStable$.pipe(operators.mergeMap(function () { return ngbRunTransition(nativeElement, function (_b) {
    ...
    var NgbNavConfig = /** @class */ (function () {
        function NgbNavConfig(ngbConfig) {
            this.destroyOnHide = true;
    ...
    var NgbNavOutlet = /** @class */ (function () {
        ...
        NgbNavOutlet.prototype.ngAfterViewInit = function () {
            ...
            this.nav.navItemChange$
                .pipe(operators.startWith(((_c = this._activePane) === null || _c === void 0 ? void 0 : _c.item) || null), operators.distinctUntilChanged(), operators.skip(1))
                ...
                if (_this._activePane) {
                    ngbRunTransition(_this._activePane.elRef.nativeElement, ngbNavFadeOutTransition, options).subscribe(function () {
                        ...
                        // fading in
                        if (_this._activePane) {
                            var fadeInTransition = _this.nav.animation ? ngbNavFadeInTransition : ngbNavFadeInNoReflowTransition;
                            ngbRunTransition(_this._activePane.elRef.nativeElement, fadeInTransition, options).subscribe(function () {
                                if (nextItem) {
                                    nextItem.shown.emit();
    ...
    var NgbPopoverConfig = /** @class */ (function () {
        function NgbPopoverConfig(ngbConfig) {
            this.autoClose = true;
            this.placement = 'auto';
            this.triggers = 'click';
    ...
    var NgbToastConfig = /** @class */ (function () {
        function NgbToastConfig(ngbConfig) {
            this.autohide = true;
            this.delay = 500;
    ...
    var NgbTooltipConfig = /** @class */ (function () {
        function NgbTooltipConfig(ngbConfig) {
            this.autoClose = true;
            this.placement = 'auto';
