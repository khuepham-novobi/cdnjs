...
(function (global, factory) {
  ...
  function debounce(fn, wait = 0, token = { cancelled: false }) {
      if (!wait) {
          return fn;
      }
      let timeout;
  ...
  function useField(fieldName, rules, opts) {
      ...
      const nonYupSchemaRules = extractRuleFromSchema((_a = opts === null || opts === void 0 ? void 0 : opts.form) === null || _a === void 0 ? void 0 : _a.schema, unwrap(fieldName));
