...
(function (global, factory) {
  ...
  function useValidationState({ fieldName, initValue, form, type, valueProp, }) {
      ...
      const initialValue = initValue !== null && initValue !== void 0 ? initValue : getFromPath(vue.inject('$_veeFormInitValues', {}), unwrap(fieldName));
  ...
  const Field = vue.defineComponent({
      ...
      setup(props, ctx) {
          const { disabled, rules } = vue.toRefs(props);
  ...
  function useForm(opts) {
      ...
      vue.provide('$_veeFormInitValues', (opts === null || opts === void 0 ? void 0 : opts.initialValues) || {});
      return {
          errors,
          meta,
          form: controller,
