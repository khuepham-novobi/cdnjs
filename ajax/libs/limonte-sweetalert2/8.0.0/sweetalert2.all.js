...
if (typeof window !== 'undefined' && window.Sweetalert2){  window.Sweetalert2.version = '8.0.0';  window.swal = window.sweetAlert = window.Swal = window.SweetAlert = window.Sweetalert2}
