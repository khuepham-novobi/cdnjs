...
var MultiSelect = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('dropdown', { ref: "dropdown", style: _vm.containerStyles, attrs: { "not-close-elements": _vm.els, "append-to-body": _vm.appendToBody, "disabled": _vm.disabled }, nativeOn: { "keydown": function keydown($event) {
      ...
      return [item.$group ? _c('li', { staticClass: "dropdown-header", domProps: { "textContent": _vm._s(item.$group) } }) : _vm._e(), _vm._v(" "), _vm._l(item.options, function (_item) {
        return [_c('li', { class: _vm.itemClasses(_item), staticStyle: { "outline": "0" }, on: { "keydown": [function ($event) {
              ...
              _vm.currentActive = -1;
            } } }, [_vm.customOptionsVisible ? _c('a', { staticStyle: { "outline": "0" }, attrs: { "role": "button" } }, [_vm._t("option", null, { "item": _item }), _vm._v(" "), _vm.selectedIcon && _vm.isItemSelected(_item) ? _c('span', { class: _vm.selectedIconClasses }) : _vm._e()], 2) : _vm.isItemSelected(_item) ? _c('a', { staticStyle: { "outline": "0" }, attrs: { "role": "button" } }, [_c('b', [_vm._v(_vm._s(_item[_vm.labelKey]))]), _vm._v(" "), _vm.selectedIcon ? _c('span', { class: _vm.selectedIconClasses }) : _vm._e()]) : _c('a', { staticStyle: { "outline": "0" }, attrs: { "role": "button" } }, [_c('span', [_vm._v(_vm._s(_item[_vm.labelKey]))])])])];
      })];
    })], 2)], 2);
  }, staticRenderFns: [],
  mixins: [Local],
  ...
  computed: {
    ...
    flattenGroupedOptions: function flattenGroupedOptions() {
      ...
      return (_ref = []).concat.apply(_ref, toConsumableArray(this.groupedOptions.map(function (v) {
        return v.options;
      })));
    },
    ...
    selectedIconClasses: function selectedIconClasses() {
      ...
      return _ref3 = {}, defineProperty(_ref3, this.selectedIcon, true), defineProperty(_ref3, 'pull-right', true), _ref3;
    },
