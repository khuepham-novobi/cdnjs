        ...
        if (distance <= container.retina.grabModeDistance) {
          ...
          if (opacityLine > 0) {
            ...
            if (!container.particles.grabLineColor) {
              container.particles.grabLineColor = optColor === Constants["a" /* Constants */].randomColorValue || ((_b = optColor) === null || _b === void 0 ? void 0 : _b.value) === Constants["a" /* Constants */].randomColorValue ? Constants["a" /* Constants */].randomColorValue : ColorUtils["a" /* ColorUtils */].colorToRgb(optColor);
            }
...
class Container_Container {
  ...
  draw() {
    this.drawAnimationFrame = Utils["a" /* Utils */].animate(timestamp => {
      var _a;

      return (_a = this.drawer) === null || _a === void 0 ? void 0 : _a.nextFrame(timestamp);
    });
  }
