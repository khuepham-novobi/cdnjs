...
/* harmony import */ var _ColorUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
...
class CanvasUtils {
  ...
  static drawLight(container, context, mousePos) {
    context.beginPath();
    context.arc(mousePos.x, mousePos.y, Math.max(container.canvas.size.height, container.canvas.size.width), 0, 2 * Math.PI);
    const gradientAmbientLight = context.createRadialGradient(mousePos.x, mousePos.y, 0, mousePos.x, mousePos.y, 1000);
