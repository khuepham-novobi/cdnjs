...
var styles = function styles(theme) {
  return {
    ...
    light: {
      borderColor: (0, _colorManipulator.fade)(theme.palette.divider, 0.08)
    },
...
var Divider = /*#__PURE__*/React.forwardRef(function Divider(props, ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, (0, _extends2.default)({
    className: (0, _clsx.default)(classes.root, classes[variant], themeVariantsClasses, className, absolute && classes.absolute, flexItem && classes.flexItem, light && classes.light, orientation === 'vertical' && classes.vertical),
    role: role,
    ref: ref
  }, other));
});
