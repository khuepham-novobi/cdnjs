...
process.env.NODE_ENV !== "production" ? Typography.propTypes = {
   ...
   */
  variant: _propTypes.default.oneOf(['body1', 'body2', 'button', 'caption', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'inherit', 'overline', 'subtitle1', 'subtitle2']),
   ...
   */
  variantMapping: _propTypes.default.shape({
    body1: _propTypes.default.string,
    body2: _propTypes.default.string,
    ...
    overline: _propTypes.default.string,
    subtitle1: _propTypes.default.string,
