(function (global, factory) {
	...
	(global = global || self, factory(global.Imgix = {}));
	...
	*/
	...
	if (descriptors && !has(TypedArrayPrototype, TO_STRING_TAG$2)) {
	  ...
	  defineProperty$2(TypedArrayPrototype, TO_STRING_TAG$2, {
	    get: function () {
	...
	var setToStringTag = function (it, TAG, STATIC) {
	  if (it && !has(it = STATIC ? it : it.prototype, TO_STRING_TAG$3)) {
	    defineProperty$3(it, TO_STRING_TAG$3, {
	      configurable: true,
	      value: TAG
	    });
	  }
	...
	_export({
	  target: 'Array',
	  proto: true,
	  forced: NEGATIVE_ZERO$1 || !STRICT_METHOD$2 || !USES_TO_LENGTH$2
	}, {
	...
	var FORCED$5 = !descriptors || FAILS_ON_PRIMITIVES; // `Object.getOwnPropertyDescriptor` method
	// https://tc39.github.io/ecma262/#sec-object.getownpropertydescriptor
	...
	var USES_TO_LENGTH$3 = arrayMethodUsesToLength('every'); // `Array.prototype.every` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.every
	...
	var USES_TO_LENGTH$5 = arrayMethodUsesToLength('forEach'); // `Array.prototype.forEach` method implementation
	// https://tc39.github.io/ecma262/#sec-array.prototype.foreach

	var arrayForEach = !STRICT_METHOD$4 || !USES_TO_LENGTH$5 ? function forEach(callbackfn
	/* , thisArg */
	) {
	...
	_export({
	  target: 'Array',
	  proto: true,
	  forced: !STRICT_METHOD$5 || !USES_TO_LENGTH$7
	}, {
	...
	var USES_TO_LENGTH$8 = arrayMethodUsesToLength('splice', {
	  ACCESSORS: true,
	  0: 0,
	  1: 2
	});
	...
	var FORCED$7 = !global_1.setImmediate || !global_1.clearImmediate; // http://w3c.github.io/setImmediate/
	...
	exports.IxImg = class IxImg extends IxImgProps {
	    created() {
	...
	class VueImgixClient {
	    constructor(options) {
	        ...
	        this.buildUrlObject = (url, ixParams, options = {}) => {
	            const { widths, widthTolerance, minWidth, maxWidth, ...sharedOptions // Right now this is only passed to buildSrcSet, but in the future it might be passed to buildUrl
	             } = options;
	        ...
	        this.buildSrcSet = (url, ixParams, options) => {
	...
	let vueImgixClientSingleton = undefined;
