(function (global, factory) {
	...
	*/
	...
	var USES_TO_LENGTH$1 = arrayMethodUsesToLength('every'); // `Array.prototype.every` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.every
	...
	if (FORCED$2) {
	  var RegExpWrapper = function RegExp(pattern, flags) {
	    ...
	    if (UNSUPPORTED_Y$1 && sticky) setInternalState$3(result, {
	      sticky: sticky
	    });
	    return result;
	  };
	...
	var arrayValues = es_array_iterator.values;
	var arrayKeys$1 = es_array_iterator.keys;
	...
	exportTypedArrayMethod$a('keys', function keys() {
	  return arrayKeys$1.call(aTypedArray$a(this));
	...
	var STRICT_METHOD$5 = arrayMethodIsStrict('lastIndexOf'); // For preventing possible almost infinite loop in non-standard implementations, test the forward version of the method

	var USES_TO_LENGTH$8 = arrayMethodUsesToLength('indexOf', {
	  ACCESSORS: true,
	  1: 0
	});
	var FORCED$4 = NEGATIVE_ZERO$1 || !STRICT_METHOD$5 || !USES_TO_LENGTH$8; // `Array.prototype.lastIndexOf` method implementation
	// https://tc39.github.io/ecma262/#sec-array.prototype.lastindexof

	var arrayLastIndexOf = FORCED$4 ? function lastIndexOf(searchElement
	/* , fromIndex = @[*-1] */
	) {
	  // convert -0 to +0
