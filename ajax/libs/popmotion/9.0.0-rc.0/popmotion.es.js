...
var SpringAnimator = /*#__PURE__*/function () {
    ...
    SpringAnimator.uniqueOptionKeys = /*#__PURE__*/new Set(["stiffness", "damping", "mass", "restSpeed", "restDelta"]);
...
function animate(_a) {
    var from = _a.from,
        ...
        options = __rest(_a, ["from", "to", "autoplay", "driver", "elapsed", "repeat", "repeatType", "repeatDelay", "onPlay", "onComplete", "onRepeat", "onUpdate"]);
    var driverControls;
    var repeatCount = 0;
