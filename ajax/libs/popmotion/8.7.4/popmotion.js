(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var prevTime$1 = 0;
    var onNextFrame$1 = typeof window !== 'undefined' && window.requestAnimationFrame !== undefined ? function (callback) {
        return window.requestAnimationFrame(callback);
    } : function (callback) {
        var timestamp = Date.now();
        var timeToCall = Math.max(0, 16.7 - (timestamp - prevTime$1));
        prevTime$1 = timestamp + timeToCall;
        setTimeout(function () {
            return callback(prevTime$1);
        }, timeToCall);
    };

    var createStep$1 = function (setRunNextFrame) {
        var processToRun = [];
        var processToRunNextFrame = [];
        var numThisFrame = 0;
        var isProcessing = false;
    ...
    var maxElapsed$1 = 40;
    var defaultElapsed$1 = 1 / 60 * 1000;
    var useDefaultElapsed$1 = true;
    var willRunNextFrame$1 = false;
    ...
    var setWillRunNextFrame$1 = function (willRun) {
        return willRunNextFrame$1 = willRun;
    };
    var steps$1 = /*#__PURE__*/stepsOrder$1.reduce(function (acc, key) {
        acc[key] = createStep$1(setWillRunNextFrame$1);
        return acc;
    }, {});
    var sync$1 = /*#__PURE__*/stepsOrder$1.reduce(function (acc, key) {
        ...
        acc[key] = function (process, keepAlive, immediate) {
            ...
            if (!willRunNextFrame$1) startLoop$1();
            step.schedule(process, keepAlive, immediate);
            return process;
        };
        return acc;
    ...
    var processFrame$1 = function (timestamp) {
        willRunNextFrame$1 = false;
        frame$1.delta = useDefaultElapsed$1 ? defaultElapsed$1 : Math.max(Math.min(timestamp - frame$1.timestamp, maxElapsed$1), 1);
        if (!useDefaultElapsed$1) defaultElapsed$1 = frame$1.delta;
        frame$1.timestamp = timestamp;
        isProcessing$1 = true;
        stepsOrder$1.forEach(processStep$1);
        isProcessing$1 = false;
        if (willRunNextFrame$1) {
            useDefaultElapsed$1 = false;
            onNextFrame$1(processFrame$1);
        }
    };
    var startLoop$1 = function () {
        willRunNextFrame$1 = true;
    ...
    var ValueReaction = (function (_super) {
        ...
        function ValueReaction(props) {
            ...
            _this.scheduleVelocityCheck = function () { return sync$1.postRender(_this.velocityCheck); };
            ...
            if (isSingleValue(_this.current)) {
                ...
                _this.updateCurrent = function (v) { return (_this.current = __spreadArrays(v)); };
        ...
        ValueReaction.prototype.update = function (v) {
            ...
            sync$1.postRender(this.scheduleVelocityCheck);
        };
                        ...
                        complete: function () {
                            if (!hasCompleted) {
                                ...
                                if (numCompletedActions === numActions)
                                    sync$1.update(complete);
                            }
                        },
                        error: error,
                        update: function (v) {
                            setProp(output, name, v);
                            sync$1.update(updateOutput, false, true);
                        }
                    });
                });
    ...
    var decay = function (props) {
        ...
        return action(function (_a) {
            ...
            var process = sync$1.update(function (_a) {
    ...
    var tween = function (props) {
        ...
        return action(function (_a) {
            ...
            var startTimer = function () {
                isActive = true;
                process = sync$1.update(function (_a) {
                    var delta = _a.delta;
                    elapsed += delta;
                    updateTween();
                    if (isTweenComplete()) {
                        cancelSync.update(process);
                        complete && sync$1.update(complete, false, true);
                    }
                }, true);
            };
            ...
            return {
                ...
                seek: function (newProgress) {
                    ...
                    sync$1.update(updateTween, false, true);
                    return this;
                },
                reverse: function () {
                    reverseAnimation();
